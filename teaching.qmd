...
[{{< fa file-lines >}} Teaching Philosophy](teaching_philosophy.pdf){.btn .btn-pub .btn-sm target="_blank"} [{{< fa chart-bar >}} Teaching Evaluations](DeStefani_all_teaching_evaluations.pdf){.btn .btn-pub .btn-sm target="_blank"}
